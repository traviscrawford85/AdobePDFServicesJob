...
class ExportPDFToDOCX:
    def __init__(self):
        try:
            file = open('/mnt/c/Users/LAWCLERK/Ledyard Law/Information Technology - General/projects/PDFServicesSDK-PythonSamples/AdobePDFServicesJob/Bodea Brochure.pdf', 'rb')
